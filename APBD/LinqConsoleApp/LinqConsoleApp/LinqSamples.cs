    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            //1. Query syntax (SQL)
            var res = from emp in Emps //dla kazdego emp w emps
                      where emp.Job == "Backend programmer"//kiedy - warunek
                      select new    //w
                      {
                          Nazwisko = emp.Ename,
                          Zawod = emp.Job
        ...
        public void Przyklad7()
        {
            var res = from emp in Emps
                      ...
                      {
                          Praca = emp.Job,
                          IlePrac = (Emps.Where(x => x.Job == emp.Job)).Count()
                      };
            foreach (var re2 in res.Distinct())
            {
                Console.WriteLine(re2);
            }
        }
        ...
        {
            var res = Emps.SelectMany(x=>Depts,(y,z)=>new { EmpName=y.Ename,EmpJob=y.Job,z});
            foreach (var re2 in res)
            {
                Console.WriteLine(re2);
            }
