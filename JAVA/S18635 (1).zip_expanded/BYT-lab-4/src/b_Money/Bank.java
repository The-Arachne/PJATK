...
public class Bank {
	...
	/*TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	 * Nie pamietam dokladnie ktora to byla metoda ale z ctrl jak sie kliknie w wywolywana metode to wyskakuje jej kod zrodlowy,
	 *  i w polaczeniu z print znalazlem ze brakuje ! przed contains*/
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			//System.out.println("Account added to bank database");
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			//System.out.println("Account finded");
