...
public class Account {
	...
	}/* az razilo w oczy ten podwojny tick - dodanie print w odpowiednich miejscach odkrylo problem*/
	...
	public void withdraw(Money money) {
		//System.out.println(content.getAmount()+" "+money.getAmount());
		content=content.sub(money);
		//System.out.println(content.getAmount()+"?//////////////");
	}
