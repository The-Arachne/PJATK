...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		return (int)(this.getAmount()*this.currency.getRate());
	}
	...
	public Boolean equals(Money other) {
		//System.out.println(this.currency.universalValue(this.amount));
		//System.out.println(other.currency.universalValue(other.amount));
		return (this.currency.universalValue(this.amount)).equals(other.currency.universalValue(other.amount));
	}
	...
	public Money add(Money other) {
		Money tmp=new Money(this.amount, this.currency);
		tmp.amount=(int) (tmp.amount+tmp.currency.valueInThisCurrency(other.amount, other.currency));
		return tmp;
	}
	...
	public int compareTo(Object other) {
		try{
			Money tmp=(Money)other;
			return (this.currency.universalValue(this.amount)<tmp.currency.universalValue(tmp.amount))?-1:(this.currency.universalValue(this.amount)>tmp.currency.universalValue(tmp.amount))?1:0;
