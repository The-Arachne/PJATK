...
public class Currency {
	 ...
	 * @return The value of amount in the Double - "universal currency"
	 */
	 ...
	 * 
	 * @return Double - rate of this Currency 
	 */
	 ...
	 * 
	 * @param Double - rate New rate for this Currency
	 */
	...
	*/
	public Double valueInThisCurrency(Integer amount, Currency othercurrency) {
		return (othercurrency.universalValue(amount)/this.rate);
	}
}
